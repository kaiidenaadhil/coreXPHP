      ...
      <form class="auth-form-container" method="POST" action="<?= ROOT ?>/login">
        ...
        <div class="auth-form-padding">
          ...
          <div style="margin:0px auto;">
            <img src="<?= ASSETS ?>/img/logoi.svg" style="margin: 0.5rem 4rem;">
          </div>
          <div style="text-align:center;text-align: center;">
            <h3>Enter Our Universe</h3>

          </div>
          
          <div style="text-align: center;padding:0.5rem 0rem;">
            <p>to continue to Mornstar</p>
...
<?php if (!isset($_SESSION['userAltName'])) { ?>
      ...
      <?php } ?>
          <!-- <a href="<?=ROOT?>/login/?provider=google">
          <div style="margin-top:5px;padding: 0.5rem 0rem;background: #d60000;color: white;border-radius: 0.5rem;border: 1px solid #ffffff;"><i class="uil uil-google"></i> sign in with Google</div>
          </a> -->
          Or,
          </div>
          <div class="form-group">
            <div class="input-group">
              <input type="email" id="email" name="userEmail" placeholder="Email" value="ahadulamin@gmail.com" required>
              <span class="input-icon"><i class="uil uil-envelope"></i></span>
            </div>
          </div>
          <div class="form-group">
            <div class="input-group">
              <input type="password" id="password" name="userPassword" placeholder="Password" value="ahadulamin@gmail.com" required>
          ...
          <div style="text-align:center;text-align: center;padding:1rem;">
            <p> New to Mornstar? <a href="<?= ROOT ?>/register" class="normal-link">Create An Account</a> </p>
          </div>
        </div>
      </form>
